...
- Divide the data into bins, often 10 or 20 at most.

- Estimate the percentage of good and bad customers.

- Take the natural log and use that to calculate the WOE.
    
- Substitute the estimated WOE values for the original data.
