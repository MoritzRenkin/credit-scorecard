...
## Predicting (forecasting) probabilities and scorepoints (jacob)

Below the first 6 predicted scores are shown for the train and test data.
...
|Method | In-Sample Gini-Coefficient | Out-of-Sample Gini-Coefficient |
 | -------- | -------- | ------- |
|Second iteration Scorecard | Wert eintragen | Wert eintragen |
|Second iteration WOE-Binning | Wert eintragen | Wert eintragen |
|Second iteration GRP-Binning | Wert eintragen | Wert eintragen |

As expected the In-Sample Gini-Coefficient is much higher as the OoS-Gin-Coeficient, but still performing well with over 50%.
