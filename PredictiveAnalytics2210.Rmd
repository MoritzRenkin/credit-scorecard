...
As expected the In-Sample Gini-Coefficient is much higher as the OoS-Gin-Coeficient, but still performing well with over 50%. The Out-of-Sample testing represtens a real world data set much better than the In-Sample testing.
